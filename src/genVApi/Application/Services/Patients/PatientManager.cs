...
public class PatientManager : IPatientService
{
    ...
    public async Task<ICollection<Patient>> AddRangeAsync(ICollection<Patient> patients)
    {
    ...
    public async Task<ICollection<Patient>> UpdateRangeAsync(ICollection<Patient> patients)
    {
        ICollection<Patient> updatedPatients = await _patientRepository.UpdateRangeAsync(patients);
