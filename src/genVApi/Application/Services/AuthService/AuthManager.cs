...
public class AuthManager : IAuthService
{
    ...
    {
        IPaginate<RefreshToken> page = await _refreshTokenRepository.GetListAsync(
            predicate: r => r.UserId == userId && r.RevokedDate == null,
            index: 0,
            size: int.MaxValue,
            enableTracking: true,
        ...
        foreach (RefreshToken t in page.Items)
            await RevokeRefreshToken(t, ipAddress, reason: reason, replacedByToken: null);
    }
