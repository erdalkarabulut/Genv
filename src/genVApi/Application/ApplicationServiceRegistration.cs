...
using Application.Services.Bags;
using Application.Services.BagMovements;
using Application.Services.Boxes;
using Application.Services.CollectionSessions;
using Application.Services.DliProducts;
using Application.Services.Donors;
...
public static class ApplicationServiceRegistration
{
    ...
    )
    {
        ...
        services.AddScoped<IBagService, BagManager>();
        services.AddScoped<IBagMovementService, BagMovementManager>();
        services.AddScoped<IBoxService, BoxManager>();
        services.AddScoped<ICollectionSessionService, CollectionSessionManager>();
        services.AddScoped<IDliProductService, DliProductManager>();
